  ...
  <ul id="m_nav_list" class="m_nav">
   ...
   <li class="m_nav_item" id="moble_nav_item_7"> <a href="#contact" class="scroll">Contact</a></li>-->
      ...
      <div class="service" id="services">
         <div class="container">
            <h3 class="title clr">Instrucciones</h3>
            <div class="pope banner-agileits-btm" id="video">
               ...
               <h4>Lea las intrucciones detalladamente antes de hacer cualquier acción en el sistema</h4>
            </div>
            <div class="clearfix"> </div>
         </div>
               ...
               <div class="col-lg-3 col-sm-6 col-xs-6 its-grid-ser">
                  <div class="services-clr">
                     <div class=" service-icon-grid-agile">
                        ...
                        <p>
                           Se debe solicitar la siguiente información al cliente: Piso donde está esta ascensor,cantidad de personas y posible motivo de falla.
                        </p>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
               ...
               <div class="col-lg-3 col-sm-6 col-xs-6 its-grid-ser">
                  <div class="services-clr">
                     <div class=" service-icon-grid-agile">
                        ...
                        <h4>Accionar</h4>
                        <p>
                           Ir a la opción de "acciones", analizar cual es el mejor método para sacar a las personas de la cabina y ejecutar.
                        </p>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
                  ...
                  <div class="services-clr">
                     <div class=" service-icon-grid-agile">
                      <h6>3</h6>
                        <h4>Llamar</h4>
                        <p>
                           Luego se debe llamar al cliente para confirmar la salida de las personas dentro de la cabina
                        </p>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
               ...
               <div class="col-lg-3 col-sm-6 col-xs-6 its-grid-ser top-ser">
                  <div class="services-clr">
                     ...
                     <h6>4</h6>
                        <h4>Comunicar</h4>
                        <p>
                           Notificar al Director General sobre la solvencia de la falla.
                        </p>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
